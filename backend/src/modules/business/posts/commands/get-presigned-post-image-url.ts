...
import type { ConfigSchema } from "@openmedia/backend/config/config"
import { S3_CLIENT } from "@openmedia/backend/modules/s3/module"
...
export class GetPresignedPostImageURLHandler
	implements ICommandHandler<GetPresignedPostImageURLCommand>
{
	imageBucket: string
